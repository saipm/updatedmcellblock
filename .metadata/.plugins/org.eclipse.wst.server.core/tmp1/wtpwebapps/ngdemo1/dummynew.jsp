...
<div id="session">
    ...
    <form class="commonForm" id="session-form" method="post" action="signinServlet" accept-charset="utf-8">
      <fieldset>
...
<p><label for="id_password">Password:</label> <input type="password" placeholder="password" name="password" id="id_password" /></p>
     ...
     <!--  <p>
        <a href="/ngdemo1/signup.jsp">Sign up</a> or <a href="/ngdemo/reset_password.html">reset your password</a>
      </p> -->
    </form> <!-- /commonForm -->
  </div> <!-- /session -->
